...
When(/^I visit a public group$/) do
  @public_group = FactoryGirl.create :group, visible: true, discussions_private_by_default: false
...
When(/^I visit a private group$/) do
  @private_group = FactoryGirl.create :group, visible: true, discussions_private_by_default: true
